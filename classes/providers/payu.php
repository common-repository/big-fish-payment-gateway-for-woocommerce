...
/**
 * BIG FISH Payment Gateway PayU provider
 * 
 */
class BigFishPaymentGatewayPayU extends BigFishPaymentGatewayProvider {

	protected $providerName = 'PayU';
	
	protected $providerLongName = 'PayU';

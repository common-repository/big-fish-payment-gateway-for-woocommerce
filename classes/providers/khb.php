...
/**
 * BIG FISH Payment Gateway KHB provider
 * 
 */
class BigFishPaymentGatewayKHB extends BigFishPaymentGatewayProvider {

	protected $providerName = 'KHB';
	
	protected $providerLongName = 'K&H Bank';

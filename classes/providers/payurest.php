...
/**
 * BIG FISH Payment Gateway PayU REST provider
 *
 */
class BigFishPaymentGatewayPayURest extends BigFishPaymentGatewayProvider {

	protected $providerName = 'PayURest';

	protected $providerLongName = 'PayU REST';

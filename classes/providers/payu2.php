...
/**
 * BIG FISH Payment Gateway PayU2 provider
 * 
 */
class BigFishPaymentGatewayPayU2 extends BigFishPaymentGatewayProvider {

	protected $providerName = 'PayU2';
	
	protected $providerLongName = 'PayU (Classic)';

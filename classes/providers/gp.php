...
/**
 * BIG FISH Payment Gateway Global Payments provider
 * 
 */
class BigFishPaymentGatewayGP extends BigFishPaymentGatewayProvider {

	protected $providerName = 'GP';

	protected $providerLongName = 'Global Payments';

...
/**
 * BIG FISH Payment Gateway PayPal REST provider
 * 
 */
class BigFishPaymentGatewayPayPalRest extends BigFishPaymentGatewayProvider {

	protected $providerName = 'PayPalRest';

	protected $providerLongName = 'PayPal REST';

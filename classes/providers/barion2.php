...
/**
 * BIG FISH Payment Gateway Barion2 provider
 * 
 */
class BigFishPaymentGatewayBarion2 extends BigFishPaymentGatewayProvider {

	protected $providerName = 'Barion2';

	protected $providerLongName = 'Barion Smart Gateway';

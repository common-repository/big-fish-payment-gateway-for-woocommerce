...
/**
 * BIG FISH Payment Gateway OTPay provider
 * 
 */
class BigFishPaymentGatewayOTPay extends BigFishPaymentGatewayProvider {

	protected $providerName = 'OTPay';
	
	protected $providerLongName = 'OTPay';

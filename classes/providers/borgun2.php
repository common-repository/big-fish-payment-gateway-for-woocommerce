...
/**
 * BIG FISH Payment Gateway Borgun RPG provider
 * 
 */
class BigFishPaymentGatewayBorgun2 extends BigFishPaymentGatewayProvider {

	protected $providerName = 'Borgun2';
	
	protected $providerLongName = 'Borgun RPG';

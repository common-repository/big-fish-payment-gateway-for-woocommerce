...
/**
 * BIG FISH Payment Gateway Wirecard provider
 *
 */
class BigFishPaymentGatewayWirecard extends BigFishPaymentGatewayProvider {

	protected $providerName = 'Wirecard';

	protected $providerLongName = 'Wirecard';
